...
- [Technical Details of Models](#technical-details-of-models)
  * [AutoEncoder](#autoencoder)
  * [VQVAE](#vqvae)
  * [Transformer](#transformer)
  * [VQGAN](#vqgan)
  * [VQGAN + CLIP](#vqgan---clip)
  * [Paint Transformer](#paint-transformer)
  * [Stroke Render](#stroke-render)
  * [Stroke Predictor](#stroke-predictor)
- [Implementation](#implementation)
  * [VQGAN + CLIP](#vqgan---clip-1)
  * [Paint Transformer](#painttransformer)
- [Demo](#demo)
- [Reference](#reference)
...
```
#### Drawing process
The result oil painting will be generated by the combination of two convolutional network output: image and current canvas. The convolutional network encoder implementation is implemented as followed:
## Implementation
...
#### Dataset Selection:
- Original no-dataset approach (20000 samples)
...
:-------------------------:|:-------------------------:
Model provided | ![0](/assets/images/team02/model0.gif)
Original approach |  ![0](/assets/images/team02/model1.gif)
Miniplaces  |  ![0](/assets/images/team02/model2.gif)
Landscape  |  ![0](/assets/images/team02/model3.gif)

#### Summary:
Among all three results, the painting from Miniplaces and no-dataset approach performs similarly and better than the Landscape Pictures dataset. Our implementation confirmed the statement in the [paper](https://arxiv.org/abs/2108.03798) that the no-dataset approach can achieve similar performance without extra training time.
## Demo
